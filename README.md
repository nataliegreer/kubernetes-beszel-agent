...
A [Kubernetes DaemonSet]([https://github.com/nataliegreer/kubernetes-beszel-agent/blob/main/beszel-agent.yaml](https://kubernetes.io/docs/concepts/workloads/controllers/daemonset/)) that deploys beszel-agent with automatic system naming. Just apply this daemonset and your nodes with automatically add themselves as systems to your Beszel hub.
